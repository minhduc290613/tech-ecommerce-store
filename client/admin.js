...
function bindEvents() {
  ...
  mountTechnicalSpecsEditor(); mountContactSettingsFields(); mountEnglishBrandContentFields(); mountEnglishPageContentFields(); mountBrandAssetUploads(); mountSaleAdminUI(); mountProductShopSelector();
