...
async function saveProduct(event) {
  ...
  const payload = {
    ...
    price, original_price: originalPrice, is_active: $("#productActive").checked, is_sale: $("#productSale").checked, featured: $("#productFeatured").checked, updated_at: new Date().toISOString(),
  };
