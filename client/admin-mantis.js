...
const state = { db: null, session: null, user: null, role: "customer", isAdmin: false, language: localStorage.getItem("nexora-mantis-language") || "en", theme: localStorage.getItem("nexora-mantis-theme") || (window.matchMedia?.("(prefers-color-scheme: dark)").matches ? "dark" : "light"), orders: [] };
